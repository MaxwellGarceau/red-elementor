<?php
namespace ElementorExtras\Modules\RedSwitcher\Widgets;
 ...
 * @since 1.9.0
 */
class RedSwitcher extends Extras_Widget {
	...
	public function get_title() {
		return __( 'Red Switcher', 'elementor-extras' );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new RedSwitcher() );
